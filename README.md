...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=220&section=header&text=Shefali%20Chaudhary&fontSize=72&fontAlignY=38&animation=fadeIn&fontColor=ffffff&desc=DevOps%20Engineer%20%2F%2F%20Cloud%20Architect%20%2F%2F%20SRE&descAlignY=62&descAlign=50&descSize=17" />
...
```
╔══════════════════════════════════════════════════════════════════════╗
║  🎨  "The pipeline is my canvas, the commit is my brushstroke."      ║
║                                       — Shefali's DevOps Manifesto   ║
╚══════════════════════════════════════════════════════════════════════╝
```

<img src="https://readme-typing-svg.demolab.com?font=Space+Mono&weight=700&size=16&pause=1000&color=F97316&center=true&vCenter=true&width=720&lines=Where+every+git+commit+is+a+brushstroke...;...and+every+pipeline+is+a+masterpiece+in+progress.;Ship+fast.+Rollback+faster.+Sleep+through+the+night.;If+it%27s+not+in+Git%2C+it+doesn%27t+exist." />

🖌️ *Where every `git commit` is a brushstroke and every `pipeline` is a masterpiece in progress*

</div>

---

## 🎬 Zindagi Na Milegi Dobara — A DevOps Reading

> *Bollywood × Cloud Engineering — because some songs just sound like a CI/CD pipeline running at 2am*
...
| *"Leave the shore behind, discover the horizon"* | Migrate to Kubernetes. The monolith is the shore. Microservices are the horizon. |
| *"Dikhne mein chhoti si lagti hai, par hai badi mushkil"* | A 3-line Terraform change that takes 3 days of `plan/destroy/import`. |
| *"We are here today, gone tomorrow"* | Ephemeral infra only. Nothing is permanent. Except the IaC state file. |

> Zindagi na milegi dobara — **and neither will your prod deployment window.**
> The Bollywood hero jumps into the sea with no plan.
> The DevOps engineer jumps in with **Terraform, a rollback strategy, and a Grafana dashboard already open.**
...
Every pipeline should be so clean it **runs itself at 3am without waking anyone up**.
...
![Kubernetes](https://img.shields.io/badge/Kubernetes-326CE5?style=flat-square&logo=kubernetes&logoColor=white)
![Helm](https://img.shields.io/badge/Helm-0F1689?style=flat-square&logo=helm&logoColor=white)
![EC2/EKS/ECS](https://img.shields.io/badge/EC2%20%2F%20EKS%20%2F%20ECS-FF9900?style=flat-square&logo=amazonaws&logoColor=white)
![Route53](https://img.shields.io/badge/Route%2053-8C4FFF?style=flat-square)
![ALB/NLB](https://img.shields.io/badge/ALB%20%2F%20NLB-555555?style=flat-square)
...
![Bicep](https://img.shields.io/badge/Azure_Bicep-1E90FF?style=flat-square)
![Terragrunt](https://img.shields.io/badge/Terragrunt-844FBA?style=flat-square)
...
```
The pipeline is my canvas.
The commit is my brushstroke.
The cluster is my gallery.
```

*Shefali Chaudhary · DevOps Engineer · Built with intention, deployed with confidence*
